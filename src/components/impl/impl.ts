...
let AboutUs : SiteContent.About={
    ...
    Header :{
        title : 'About Us',
        content : 'Our potential team of developers expertise in software research, design, and development. We provide web and software development, website designing, E-Commerce solution, Tech-consulting, Redesigning and revamping, content management service businesses. Our adaptive thinking lets us offer solution to any business range with proficiency and reliability.',
    ...
    content : [       
        {
            ...
            content:'In this fast-paced technology world keeping up to date is challenging to business owners to remain on top of the latest technology. Let us bring down your burden to filter out what’s best and always position you on top in your business.',
            stylecss:'fa fa-shopping-bag'
        },
        {
            title:'Staying in Tune',
            content:'It is our jobs – and our hobby, to always stay in tune with the latest technology and information technology developments and trends, and it is our expertise that allows us to determine which developments are right for which clients',
            stylecss:'fa fa-photo'
        },
        {
            title:'Sharing Ideas',
            content:'With trends always coming and going, it can seem like businesses are always just trying to catch up with the next big thing. We set up periodic meetings with our clients to talk about technology on the job. These meetings are great to learn about emerging tech, how others are using it and expected changes in your industry',
            stylecss:'fa fa-bar-chart'
        },
        {
            title:'Effective Communication & Education',
            content:'Our success depends on utilizing the knowledge, talents, and experience from both of us. We have patience and humility to learn from you and understand different practices and priorities that you have in your existing business and process. When you are confused about an idea and hesitant to follow our advice, we take time to explain why you should believe it is effective solution and technology.<br/> While you might be unfamiliar with your industry, it is our responsibility to bring you how others are performing and expecting changes through technology in your industry.   We educate and inform rather than saying. Similarly, we are willing to accept suggestions and guidance from you especially business to business interactions.',
            
        },
        {
            title:'Customer relationship & Feedback',
            content:'We maintain good customer relationship and consistent customer experience every time we interact with business and leaves them with a good impression. There is mutual regard and understanding between you and us, thus extends for a long period of time. <br/> We establish a regular feedback loop in which we ask you to let us know what is working and what’s not.',
...
let Serives: SiteContent.Service= {
    ...
    Header :{
        title : 'FreeLancing',
        content : 'We are expert on this web programming and developing world. Also, we have gathered vast knowledge about using coding, designing, developing, and other things that are related to this sector. We are always updated with new string of coding. We love learning and implementing according to time.'
    },
    content :[
    {
        title:'Web & Software Development',
        content:'We web designers and developers are well thought out professionals. We work closely and incorporate innovate ideas to bring life to your business entities for almost every industry. We go hand in hand with the client to understand their requirements. Right from requirements gathering till deploying, we closely follow each stage of the software development life cycle, and keeping our clients informed at every stage'
    },
    {
        title:'WebSite Designing',
        content:'The website and software has become an essential part of human life and their businesses. Every business needs a website to showcase its skill, products, talents, and much more. We understand the necessities and crafts exquisite website for start-ups. Get your website designed regardless of form, size, and device. We develop highly scalable responsive web layouts that seamlessly fit all screen sizes and resolutions'
    },
    {
        title:'E-Commerce Solutions',
        content:'Be it your requirement for Clothing Range, Food Delivery, Online Grocery Delivery, Electronics, Cosmetics, Travel Booking, or more, we understand the changing market trends of the industry and accordingly shapes your business concepts into workable ecommerce solutions. We use existing open-source ecommerce framework for quick and easy deployment suitable for small-size and large retailers alike'
    },
    {
        title:'Content Management',
        content:'Good content helps to get higher exposure. Effectively managing the valuable content of your website is important to keep it updated and inform your customers about the latest news, events, products, and other information related to business. If you are willing to create a comprehensive, search engine friendly website that can be managed effortlessly, we can help you to achieve that by offering content management solutions.'
    },
    {
